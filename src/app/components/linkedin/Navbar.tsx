...
const Navbar = ({ query, onQueryChange }: NavbarProps) => {
    return (
        ...
        >
            <div className="mx-auto flex h-[52px] max-w-[1188px] items-center justify-between px-10 max-sm:h-auto max-sm:justify-center max-sm:px-0">
            <div className="flex items-center space-x-2 max-sm:justify-between max-sm:w-full max-sm:px-2 max-sm:py-1.5">
                ...
                <motion.div 
                    className="flex h-[34px] w-[280px] items-center rounded-[1.6rem] border-1 border-[rgb(0,0,0,0.3)] bg-[#fff] px-3 max-sm:min-w-0 max-sm:flex-1"
                    initial={{ opacity: 0.9 }}
                    animate={{ opacity: 1 }}
            ...
            <div className="flex h-full items-end gap-0 bg-white max-sm:fixed max-sm:bottom-0 max-sm:left-0 max-sm:grid max-sm:h-fit max-sm:w-full max-sm:grid-cols-5">
                <motion.div 
                    className="flex min-w-[78px] flex-col items-center border-b-2 border-black px-2 pb-1 pt-1 text-[rgb(0,0,0,0.6)] transition-all hover:text-black max-sm:min-w-0 max-sm:border-none max-sm:px-1"
                    whileHover={{ y: -2 }}
                >
                    <motion.svg 
                        viewBox="0 0 24 24" 
                ...
                <motion.div 
                    className="flex min-w-[78px] flex-col items-center px-2 pb-1 pt-1 text-[rgb(0,0,0,0.6)] transition-all hover:text-black max-sm:min-w-0 max-sm:px-1"
                    whileHover={{ y: -2 }}
                >
                ...
                >
                    ...
                    <span className="truncate text-xs">Messages</span>
                </motion.div>
                <motion.div 
                    className="flex min-w-[78px] flex-col items-center px-2 pb-1 pt-1 text-[rgb(0,0,0,0.6)] transition-all hover:text-black max-sm:min-w-0 max-sm:px-1"
                    whileHover={{ y: -2 }}
                >
                    ...
                    <span className="truncate text-xs">Alerts</span>
                </motion.div>
                <motion.div 
