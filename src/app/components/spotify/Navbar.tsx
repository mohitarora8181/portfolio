...
const Navbar = ({ query, onQueryChange }: NavbarProps) => {
    return (
        <motion.div
            className='fixed top-0 z-30 flex w-full items-center bg-black p-2 px-3'
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
        >
            <motion.div
                className='flex w-1/2 cursor-pointer justify-start px-4 max-sm:w-auto max-sm:px-2 max-sm:py-2'
            ...
            <motion.div
                className='hidden w-1/2 cursor-pointer justify-end px-4 max-sm:ml-auto max-sm:flex max-sm:w-auto max-sm:px-2 max-sm:py-2'
                transition={{ type: 'spring', stiffness: 400, damping: 10 }}
            >
